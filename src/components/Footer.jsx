        ...
        <div className="basis-1/2 flex gap-4">
          <div className="basis-1/3">
            ...
            {["instagram", "twitter (x?)", "LinkedIn"].map((item, index) => (
              <a key={index} className="block mt-2 capitalize text-zinc-200">
                {item}
              </a>
            ))}
          </div>
          <div className="basis-1/3">
            ...
            {["Home", "Work", "Culture"].map((item, index) => (
              <a key={index} className="block mt-2 capitalize text-white">
                {item}
              </a>
            ))}
          </div>
          <div className="basis-1/2 flex flex-col items-end text-white">
